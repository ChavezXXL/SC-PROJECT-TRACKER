            ...
            <div className="inline-flex mt-6 rounded-full bg-zinc-900 border border-white/10 p-1">
              <button
                ...
                className={`px-4 py-1.5 text-sm font-bold rounded-full transition-colors ${
                  interval === 'month' ? 'bg-amber-600 text-white' : 'text-zinc-400'
                }`}
              >
                Monthly
              </button>
              <button
                ...
                className={`px-4 py-1.5 text-sm font-bold rounded-full transition-colors ${
                  interval === 'year' ? 'bg-amber-600 text-white' : 'text-zinc-400'
                }`}
              >
                ...
                >
                  ...
                  <button
                    ...
                    className={`mt-6 w-full rounded-lg px-4 py-2.5 text-sm font-bold transition-colors ${
                      isPopular || isRecommended
                        ? 'bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-400 hover:to-amber-400 text-white shadow shadow-amber-900/20'
