...
export type AppView = 'login' | 'admin-dashboard' | 'admin-jobs' | 'admin-board' | 'admin-calendar' | 'admin-logs' | 'admin-team' | 'admin-settings' | 'admin-reports' | 'admin-weekly' | 'admin-live' | 'admin-samples' | 'admin-scan' | 'admin-quotes' | 'admin-customer-pos' | 'admin-customers' | 'admin-pricing' | 'admin-quality' | 'admin-deliveries' | 'admin-purchase-orders' | 'employee-scan' | 'employee-job';
